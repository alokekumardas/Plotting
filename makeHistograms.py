...
if finalState=="Mu":
    ...
    extraCutsLooseCRe2g1       = "(passPresel_Mu && nJet==2 && nBJet>=1 )*"
    extraPhotonCutsLooseCRe2g1 = "(passPresel_Mu && nJet==2 && nBJet>=1 && %s)*"
    ...
    if runsystematic:
	 if 'PU' in syst:
		...
		outputhistName = "histograms_%s/ele/%sEleEff_%s"%(selYear,outputFileName,level)
                ...
                outputhistName = "histograms_%s/ele/%sBTagSF_%s"%(selYear,outputFileName,level)  
         elif 'BTagSF_l' in syst:
                if level=="up":
                        #btagWeightCategory = ["1","(1-btagWeight_Up[0])","(btagWeight_Up[2])","(btagWeight_Up[1])"]
                        btagWeight = "btagWeight_1a_l_Up"
          ...
          #              analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_17/13TeV_AnalysisNtuples/electrons/%s_up_"%(syst)
           #             outputhistName = "histograms_%s/ele/%s%s_up"%(selYear,outputFileName,syst)
        	...
        	if  level=="up":
            		...
            		analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_%s/13TeV_AnalysisNtuples/systematics_electrons/%s_up_"%(selYear,syst)
			
            		outputhistName = "histograms_%s/ele/%s%s_up"%(selYear,outputFileName,syst)
        	if level=="down":
            		analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_%s/13TeV_AnalysisNtuples/systematics_electrons/%s_down_"%(selYear, syst)
            		outputhistName = "histograms_%s/ele/%s%s_down"%(selYear,outputFileName,syst)
    ...
    extraCutsLooseCRe2g1       = "(passPresel_Ele && nJet==2 && nBJet>=1 )*"
    extraPhotonCutsLooseCRe2g1 = "(passPresel_Ele && nJet==2 && nBJet>=1 && %s)*"

    extraCutsLooseCR2e0       = "(passPresel_Ele && nJet>=2 && nBJet==0)*"
    extraPhotonCutsLooseCR2e0 = "(passPresel_Ele && nJet>=2 && nBJet==0 && %s)*"
    ...
    extraCutsLooseCRe2g1       = "(passPresel_Mu && nJet==2 )*"
    extraPhotonCutsLooseCRe2g1 = "(passPresel_Mu && nJet==2 && %s)*"
    ...
    extraCutsLooseCRe2g1       = "(passPresel_Ele && nJet==2  )*"
    extraPhotonCutsLooseCRe2g1 = "(passPresel_Ele && nJet==2 && %s)*"
    ...
    analysisNtupleLocation =  "root://cmseos.fnal.gov//store/user/lpctop/TTGamma_FullRun2/AnalysisNtuples/QCD_controlRegion/%s/QCDcr_"%selYear
    ...
    if runsystematic:
         if 'PU' in syst:
                ...
                outputhistName = "histograms_%s/mu/qcd%sCR_PU_%s"%(selYear,outputFileName,level)
                ...
                if level=="up":
                        ...
                        Q2="q2weight_Do"
                outputhistName = "histograms_%s/mu/qcd%sCR_Q2_%s"%(selYear,outputFileName,level)
                ...
                if syst=="Pdf":
                        ...
                        if level=="up":
                                ...
                                Pdf="pdfweight_Do"
                        outputhistName = "histograms_%s/mu/qcd%sCR_Pdf_%s"%(selYear,outputFileName,level)

                else:
                        if type(eval(syst[3:]))==type(int()):
                                pdfNumber = eval(syst[3:])
                                Pdf="pdfSystWeight[%i]/pdfWeight"%(pdfNumber-1)
                                outputhistName = "histograms_%s/mu/qcd%sCR_Pdf/Pdf%i"%(selYear,outputFileName,pdfNumber)
                ...
                outputhistName = "histograms_%s/mu/qcd%sCR_MuEff_%s"%(selYear,outputFileName,level)
                ...
                if level=="up":
                        ...
                        EleEff = "eleEffWeight_Do"
                outputhistName = "histograms_%s/mu/qcd%sCR_EleEff_%s"%(selYear,outputFileName,level)
                ...
                outputhistName = "histograms_%s/mu/qcd%sCR_PhoEff_%s"%(selYear,outputFileName,level)
                ...
                outputhistName = "histograms_%s/mu/qcd%sCR_BTagSF_%s"%(selYear,outputFileName,level)
	 elif 'BTagSF_l' in syst:
                if level=="up":
                        #btagWeightCategory = ["1","(1-btagWeight_Up[0])","(btagWeight_Up[2])","(btagWeight_Up[1])"]
                        btagWeight = "btagWeight_1a_l_Up"
                        ...
                        #btagWeightCategory = ["1","(1-btagWeight_Do[0])","(btagWeight_Do[2])","(btagWeight_Do[1])"]
                        btagWeight = "btagWeight_1a_l_Do"
                outputhistName = "histograms_%s/mu/qcd%sCR_BTagSF_l_%s"%(selYear,outputFileName,level)
            ...
            #    if level=="down":
             #           analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_17/13TeV_AnalysisNtuples/electrons/%s_down_"%(syst)
              #          outputhistName = "histograms_%s/ele/%s%s_down"%(selYear,outputFileName,syst) 
                ...
                if  level=="up":
                        #analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/lpctop/TTGamma/13TeV_AnalysisNtuples/systematics_electrons/V08_00_26_07/%s_up_"%(syst)
                        analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_%s/13TeV_AnalysisNtuples/systematics_muons/%s_up_"%(selYear,syst)

                        outputhistName = "histograms_%s/mu/qcd%sCR_%s_up"%(selYear,outputFileName,syst)
                if level=="down":
                        analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_%s/13TeV_AnalysisNtuples/systematics_muons/%s_down_"%(selYear, syst)
                        outputhistName = "histograms_%s/mu/qcd%sCR_%s_down"%(selYear,outputFileName,syst)
    ...
    extraCutsLoose            = "(passPresel_Mu && nJet>=2 )*"
    extraPhotonCutsLoose      = "(passPresel_Mu && nJet>=2  && %s)*"

    extraCutsLooseCR          = "(passPresel_Mu && nJet>=2 )*"
    extraPhotonCutsLooseCR    = "(passPresel_Mu && nJet>=2  && %s)*"
    ...
    if runsystematic:
         if 'PU' in syst:
                ...
                outputhistName = "histograms_%s/ele/qcd%sCR_PU_%s"%(selYear,outputFileName,level)
                ...
                if level=="up":
                        ...
                        Q2="q2weight_Do"
                outputhistName = "histograms_%s/ele/qcd%sCR_Q2_%s"%(selYear,outputFileName,level)
                ...
                if syst=="Pdf":
                        ...
                        if level=="up":
                                ...
                                Pdf="pdfweight_Do"
                        outputhistName = "histograms_%s/ele/qcd%sCR_Pdf_%s"%(selYear,outputFileName,level)

                else:
                        if type(eval(syst[3:]))==type(int()):
                                pdfNumber = eval(syst[3:])
                                Pdf="pdfSystWeight[%i]/pdfWeight"%(pdfNumber-1)
                                outputhistName = "histograms_%s/ele/qcd%sCR_Pdf/Pdf%i"%(selYear,outputFileName,pdfNumber)
                ...
                outputhistName = "histograms_%s/ele/qcd%sCR_MuEff_%s"%(selYear,outputFileName,level)
                ...
                if level=="up":
                        ...
                        EleEff = "eleEffWeight_Do"
                outputhistName = "histograms_%s/ele/qcd%sCR_EleEff_%s"%(selYear,outputFileName,level)
                ...
                outputhistName = "histograms_%s/ele/qcd%sCR_PhoEff_%s"%(selYear,outputFileName,level)
                ...
                if level=="up":
                        ...
                        btagWeight="btagWeight_1a_b_Do"
                print "hey I am in BTagSF in QCDEle"

                outputhistName = "histograms_%s/ele/qcd%sCR_BTagSF_%s"%(selYear,outputFileName,level)
	 elif 'BTagSF_l' in syst:
                if level=="up":
                        #btagWeightCategory = ["1","(1-btagWeight_Up[0])","(btagWeight_Up[2])","(btagWeight_Up[1])"]
                        btagWeight = "btagWeight_1a_l_Up"
                        ...
                        #btagWeightCategory = ["1","(1-btagWeight_Do[0])","(btagWeight_Do[2])","(btagWeight_Do[1])"]
                        btagWeight = "btagWeight_1a_l_Do"
                outputhistName = "histograms_%s/ele/qcd%sCR_BTagSF_l_%s"%(selYear,outputFileName,level)
             ...
             #           analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_17/13TeV_AnalysisNtuples/electrons/%s_down_"%(syst)
              #          outputhistName = "histograms_%s/ele/%s%s_down"%(selYear,outputFileName,syst) 
                ...
                if  level=="up":
                        ...
                        outputhistName = "histograms_%s/ele/qcd%sCR_%s_up"%(selYear,outputFileName,syst)
                if level=="down":
                        analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/aldas/NanoAOD/TTGamma_%s/13TeV_AnalysisNtuples/systematics_electrons/%s_down_"%(selYear, syst)
                        outputhistName = "histograms_%s/ele/qcd%sCR_%s_down"%(selYear,outputFileName,syst)
    ...
    extraCutsLoose            = "(passPresel_Ele  && nJet>=2 )*"
    extraPhotonCutsLoose      = "(passPresel_Ele  && nJet>=2  && %s)*"
    ...
    extraCutsLooseCR          = "(passPresel_Ele  && nJet>=2 )*"
    extraPhotonCutsLooseCR    = "(passPresel_Ele && nJet>=2  && %s)*"
    ...
    extraCutsLooseCRe2e2        = "(passPresel_Ele && nJet==2  )*"
    extraPhotonCutsLooseCRe2e2  = "(passPresel_Ele && %s)*" 
...
if isLooseCRe2g1Selection:
   ...
   # btagWeight = btagWeightCategory[nBJets]
    ...
    extraCuts = extraCutsLooseCRe2g1
    extraPhotonCuts = extraPhotonCutsLooseCRe2g1    
...
if plotList is None:
	...
	#plotList =  ["presel_WtransMass_METless30_control","presel_WtransMass_METgreat30_control","phosel_WtransMass_METless30","phosel_WtransMass_METgreat30"]
	#plotList =  ["presel_M3","phosel_M3","presel_WtransMass","presel_WtransMass_control","presel_WtransMass_control_cut","phosel_WtransMass","presel_WtransMass_METless30","presel_WtransMass_METgreat30","phosel_WtransMass_METless30","phosel_WtransMass_METgreat30","presel_WtransMass_METless30_control", "presel_WtransMass_METgreat30_control", "presel_Njet","presel_WtransMass", "phosel_MassEGamma", "phosel_MassEGamma_GenuinePhoton",  "phosel_MassEGamma_MisIDEle", "phosel_MassEGamma_HadronicPhoton", "phosel_MassEGamma_HadronicFake","presel_WtransMass_METless30_control_cut","presel_WtransMass_METgreat30_control_cut","phosel_WtransMass_METless30_cut","phosel_WtransMass_METgreat30_cut"]
#        plotList = ["presel_M3","phosel_M3","presel_WtransMass","presel_WtransMass_control","phosel_WtransMass","presel_WtransMass_METless30","presel_WtransMass_METgreat30","phosel_WtransMass_METless30","phosel_WtransMass_METgreat30","presel_WtransMass_METless30_control", "presel_WtransMass_METgreat30_control", "presel_Njet", "phosel_MassEGamma", "phosel_MassEGamma_GenuinePhoton",  "phosel_MassEGamma_MisIDEle", "phosel_MassEGamma_HadronicPhoton", "phosel_MassEGamma_HadronicFake"]
        plotList=["presel_Njet","presel_WtransMass","phosel_MassEGamma","phosel_MassEGamma_GenuinePhoton","phosel_MassEGamma_MisIDEle","phosel_MassEGamma_HadronicPhoton","phosel_MassEGamma_HadronicFake","phosel_Njet","phosel_WtransMass","presel_jet1Pt","phosel_jet1Pt","phosel_WtransMass_GenuinePhoton","phosel_WtransMass_MisIDEle","phosel_WtransMass_HadronicPhoton","phosel_WtransMass_HadronicFake","phosel_jet1Pt_GenuinePhoton","phosel_jet1Pt_MisIDEle","phosel_jet1Pt_HadronicPhoton","phosel_jet1Pt_HadronicFake","presel_M3", "phosel_M3", "phosel_M3_GenuinePhoton","phosel_M3_MisIDEle","phosel_M3_HadronicPhoton","phosel_M3_HadronicFake","phosel_mediumID_ChIso", "phosel_mediumID_ChIso_GenuinePhoton", "phosel_mediumID_ChIso_MisIDEle","phosel_mediumID_ChIso_HadronicPhoton","phosel_mediumID_ChIso_HadronicFake","presel_WtransMass_control","presel_WtransMass_METless30","presel_WtransMass_METgreat30","presel_WtransMass_METless30_control", "presel_WtransMass_METgreat30_control","phosel_WtransMass_METless30","phosel_WtransMass_METgreat30"]
	...
	plotList = ["presel_DilepMass","phosel_DilepMass"]
        ...
        if isLooseCRe2g1Selection or isLooseCR2e1Selection:
...
#	print hist
        ...
        if ('Data' in sample or isQCD) and not h_Info[5]:
		 print h_Info
		 continue
