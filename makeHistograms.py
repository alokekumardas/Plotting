...
if plotList is None:
	if makeAllPlots:
	   ...
	   "phosel_mediumID_ChIso", "phosel_mediumID_ChIso_GenuinePhoton", "phosel_mediumID_ChIso_MisIDEle","phosel_mediumID_ChIso_HadronicPhoton","phosel_mediumID_ChIso_HadronicFake",
           "presel_WtransMass_METless30","presel_WtransMass_METgreat30","phosel_WtransMass_METless30","phosel_WtransMass_METgreat30"]
...
if options.condor:
	print "DO COPY WITH SUBPROCESS"
	# should I copy the root file from eos to here and open ? 
#	stdout, stderr = subprocess.Popen("BASH COMMAND", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()
	subprocess.Popen("BASH COMMAND", shell=True)
...
if options.condor:
	print "copy back with subprocess"
