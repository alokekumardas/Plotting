...
def GetHistogramInfo(extraCuts="(passPresel_Mu && nJet>=3 && nBJet>=1)*", extraPhotonCuts="(passPresel_Mu && nJet>=3 && nBJet>=1 && %s)*", nBJets=1):
   ...
   #                   "presel_METPhi"                         : ["pfMETPhi"  , "presel_METPhi"   , [100,-3.15,3.15], extraCuts      , "", True],
                      ...
                      "presel_WtransMass_control"             : ["WtransMass","presel_WtransMass_control",      [200,0,200], extraPhotonCuts%(" nPho==0") , "", True],
                      ...
                      "presel_WtransMass_cut"                     : ["WtransMass","presel_WtransMass_cut",      [140,0,140], extraCuts      , "", True],
                      "presel_WtransMass_control_cut"             : ["WtransMass","presel_WtransMass_control_cut",      [140,0,140], extraPhotonCuts%("pfMET<30 && nPho==0") , "", True],
                      "presel_WtransMass_METless30_cut"           : ["WtransMass","presel_WtransMass_METless30_cut",[140,0,140], extraPhotonCuts%("pfMET<30")                         , "", True],
                      "presel_WtransMass_METgreat30_cut"          : ["WtransMass","presel_WtransMass_METgreat30_cut",[140,0,140], extraPhotonCuts%("pfMET>30")                        , "", True],
                      "presel_WtransMass_METless30_control_cut"   : ["WtransMass","presel_WtransMass_METless30_control_cut",[140,0,140], extraPhotonCuts%("pfMET<30 && nPho==0")      , "", True],
                      "presel_WtransMass_METgreat30_control_cut"  : ["WtransMass","presel_WtransMass_METgreat30_control_cut",[140,0,140], extraPhotonCuts%("pfMET>30 && nPho==0")     , "", True],
                      "phosel_WtransMass_METless30_cut"           : ["WtransMass","phosel_WtransMass_METless30_cut",[140,0,140], extraPhotonCuts%("pfMET<30 && nPho>=1")              , "", True],
                      "phosel_WtransMass_METgreat30_cut"          : ["WtransMass","phosel_WtransMass_METgreat30_cut",[140,0,200], extraPhotonCuts%("pfMET>30 && nPho>=1")             , "", True],
      ...
      #                "phosel_SecondLeadingPhotonEt"          : ["phoEt[1]"      , "phosel_SecondLeadingPhotonEt"         ,      [300,0,300], extraPhotonCuts%("nPho>=1"), "", True],
		     ...
		     "phosel_LeadingPhotonSCEta_NonPrompt_barrel"      : ["phoSCEta[0]"   , "phosel_LeadingPhotonSCEta_NonPrompt_barrel", [50,-2.5,2.5], extraPhotonCuts%("nPhoBarrel>=1 && (photonIsHadronicPhoton||photonIsHadronicFake)"), "", True],
		      ...
		      "phosel_dRLeadingPhotonJet_MisIDEle_barrel"  : ["dRPhotonJet[0]"   , "phosel_dRLeadingPhotonJet_MisIDEle_barrel" , [500,0,5], extraPhotonCuts%("nPhoBarrel>=1 && photonIsMisIDEle"), "", True],
                      ...
                      "phosel_WtransMass_1pho"                     : ["WtransMass"    , "phosel_WtransMass_1pho"      ,     [200,0,200], extraPhotonCuts%("nPho==1"), "", True],
                      "phosel_WtransMass_1pho_test"                     : ["WtransMass"    , "phosel_WtransMass_1pho_test"      ,     [200,0,200], extraPhotonCuts%("nPho==1"), "", True],
          ...
          #            "phosel_mcMomPIDHadronicPhoton"        : ["photonParentPID"   , "phosel_mcMomPIDHadronicPhoton"    ,[2000,-1000,1000], extraPhotonCuts%("nPho>=1 && photonIsHadronicPhoton") , "", False],
           #           "phosel_mcMomPIDHadronicFake"          : ["photonParentPID"   , "phosel_mcMomPIDHadronicFake"   ,[2000,-1000,1000], extraPhotonCuts%("nPho>=1 && photonIsHadronicFake")   , "", False],
		      ...
		      "phosel_MassEGamma_GenuinePhoton_barrel" : ["phoMassLepGamma", "phosel_MassEGamma_GenuinePhoton_barrel", [200,0,200], extraPhotonCuts%("nPhoBarrel>=1 && photonIsGenuine"), "", True],
                      "phosel_MassEGammaOthers_barrel"               : ["phoMassLepGamma", "phosel_MassEGammaOthers_barrel", [200,0,200], extraPhotonCuts%("nPhoBarrel>=1 && (photonIsGenuine||photonIsHadronicFake||photonIsHadronicPhoton)"), "", True],
		      "phosel_MassEGamma_NonPrompt_barrel"  : ["phoMassLepGamma", "phosel_MassEGamma_NonPrompt_barrel", [200,0,200], extraPhotonCuts%("nPhoBarrel>=1 && (photonIsHadronicFake||photonIsHadronicPhoton)"), "", True],
                      "phosel_MassEGamma_endcap"                     : ["phoMassLepGamma", "phosel_MassEGamma_endcap", [200,0,200], extraPhotonCuts%("nPho>=1 && !phoIsBarrel[0]"), "", True],
                      "phosel_MassEGammaMisIDEle_endcap"             : ["phoMassLepGamma", "phosel_MassEGammaMisIDEle_endcap", [200,0,200], extraPhotonCuts%("nPho>=1 && photonIsMisIDEle && !phoIsBarrel[0]"), "", True],
                      "phosel_MassEGammaOthers_endcap"               : ["phoMassLepGamma", "phosel_MassEGammaOthers_endcap", [200,0,200], extraPhotonCuts%("nPho>=1 && !phoIsBarrel[0] && (photonIsGenuine||photonIsHadronicFake||photonIsHadronicPhoton)"), "", True],
