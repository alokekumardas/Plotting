...
if tight_photonCategory:      #SR8    
	...
	MisIDEleSF = 4.92163 # full xrange
...
if looseCRge2ge0_photonCategory:  #AR
	...
	MisIDEleSF =  2.25683 # full range and 80-100 same value
...
x2=100/rebin
nBins = x2-x1
h1 = TH1F('myMisIDEle','',nBins/rebin,x1,x2)
h2 = TH1F('myHadronicPhoton','',nBins/rebin,x1,x2)
h3 = TH1F('myGenuinePhoton','',nBins/rebin,x1,x2)
h4 = TH1F('myHadronicFake','',nBins/rebin,x1,x2)
h5 = TH1F('myData','',nBins/rebin,x1,x2)
h6 = TH1F('myBackground','',nBins/rebin,x1,x2)
h7 = TH1F('myTotal','',nBins/rebin,x1,x2)

for i in xrange(1,nBins/rebin):
	h1.SetBinContent(i,summedHist['MisIDEle'].GetBinContent(i+x1-1))
	h2.SetBinContent(i,summedHist['HadronicPhoton'].GetBinContent(i+x1-1))
	h3.SetBinContent(i,summedHist['GenuinePhoton'].GetBinContent(i+x1-1))
	h4.SetBinContent(i,summedHist['HadronicFake'].GetBinContent(i+x1-1))
	h5.SetBinContent(i,dataHist.GetBinContent(i+x1-1))
