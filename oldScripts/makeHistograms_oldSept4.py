...
if finalState=="Mu":
    ...
    extraCutsLooseCRe3ge2        = "(passPresel_Ele && elePFRelIso<0.3 && nJet==3 && nBJet>=2)*"
    extraPhotonCutsLooseCRe3ge2  = "(passPresel_Ele && elePFRelIso<0.3 && nJet==3 && nBJet>=2 && %s)*"
...
if plotList is None:
	...
	plotList = ["presel_jet2Pt","presel_jet3Pt", "presel_jet4Pt"]
        ...
        plotList = ["phosel_LeadingPhotonEt", 
