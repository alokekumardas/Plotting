...
if isLooseCRge2e0Selection:
    ...
    outputputdir = outputdir + "_looseCRge2e0"
...
if isLooseCRe3e0Selection:
    ...
    if finalState=="Mu":
		QCDTF_pre=QCDTF_Mu_3jet0b
		QCDTF_pho=QCDTF_Mu_3jet0b_pho
    if finalState=="Ele":
		QCDTF_pre=QCDTF_Ele_3jet0b
		QCDTF_pho=QCDTF_Ele_3jet0b_pho
...
if isLooseCRe3g1Selection:
    ...
    if finalState=="Mu":
		QCDTF_pre=QCDTF_Mu_3jet1b
		QCDTF_pho=QCDTF_Mu_3jet1b_pho
    if finalState=="Ele":
		QCDTF_pre=QCDTF_Ele_3jet1b
		QCDTF_pho=QCDTF_Ele_3jet1b_pho
...
xrdcp -f "%s%s/QCD_DD.root"%(dir,outputdir) " %s%s/QCD_DD.root"%(outdir,outputdir)
