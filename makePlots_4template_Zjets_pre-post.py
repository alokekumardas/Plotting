...
if looseCRge2e0_fourTemplate:  #CR1+CR2+CR3
	...
	if selYear  =='2016': ZJetSF = getZJetsSF(selYear,isSelection); MisIDEleSF,ZGammaSF,WGammaSF = getFullYearMisIDEleSF(selYear,isSelection);
	elif selYear=='2017': ZJetSF = getZJetsSF(selYear,isSelection); MisIDEleSF,ZGammaSF,WGammaSF = getFullYearMisIDEleSF(selYear,isSelection);
	else :                ZJetSF = getZJetsSF(selYear,isSelection); MisIDEleSF,ZGammaSF,WGammaSF = getFullYearMisIDEleSF(selYear,isSelection);
...
if looseCRe2e0_fourTemplate:  #CR1
	...
	isSelection = "looseCRge2e0" # for check purpose, remove it later
	if selYear  =='2016': ZJetSF = getZJetsSF(selYear,isSelection); MisIDEleSF,ZGammaSF,WGammaSF = getFullYearMisIDEleSF(selYear,isSelection);
	elif selYear=='2017': ZJetSF = getZJetsSF(selYear,isSelection); MisIDEleSF,ZGammaSF,WGammaSF = getFullYearMisIDEleSF(selYear,isSelection);
	else :                ZJetSF = getZJetsSF(selYear,isSelection); MisIDEleSF,ZGammaSF,WGammaSF = getFullYearMisIDEleSF(selYear,isSelection);			
...
template_categoryName = {"MisIDEle":"misID ele", "ZgammaBkgPhoton":"Z#gamma", "WgammaBkgPhoton":"W#gamma", "OtherSampleBkgPhoton":"other","Total":"total" }
