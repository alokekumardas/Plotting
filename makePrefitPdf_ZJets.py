...
if selYear == "2016":
	...
	if finalState == "DiEle":
		folderName = [
		'ZJets_tightplots_ele_2016/',
		'ZJets_looseCRge2ge0plots_ele_2016/',
		'ZJets_looseCRge2e0plots_ele_2016/',
		'ZJets_looseCRe3ge2plots_ele_2016/',
		'ZJets_looseCRge4e0plots_ele_2016/',
		'ZJets_looseCRe2e1plots_ele_2016/',
		'ZJets_looseCRe2e0plots_ele_2016/',
		'ZJets_looseCRe3e1plots_ele_2016/',
		'ZJets_looseCRe2e2plots_ele_2016/',
		'ZJets_looseCRe3e0plots_ele_2016/'
		]
	elif finalState == "DiMu":
		folderName = [
		'ZJets_tightplots_mu_2016/',
		'ZJets_looseCRge2ge0plots_mu_2016/',
		'ZJets_looseCRge2e0plots_mu_2016/',
		'ZJets_looseCRe3ge2plots_mu_2016/',
		'ZJets_looseCRge4e0plots_mu_2016/',
		'ZJets_looseCRe2e1plots_mu_2016/',
		'ZJets_looseCRe2e0plots_mu_2016/',
		'ZJets_looseCRe3e1plots_mu_2016/',
		'ZJets_looseCRe2e2plots_mu_2016/',
		'ZJets_looseCRe3e0plots_mu_2016/'
		]
	...
	if finalState == "DiEle":
		folderName = [
		'ZJets_tightplots_ele_2017/',
		'ZJets_looseCRge2ge0plots_ele_2017/',
		'ZJets_looseCRge2e0plots_ele_2017/',
		'ZJets_looseCRe3ge2plots_ele_2017/',
		'ZJets_looseCRge4e0plots_ele_2017/',
		'ZJets_looseCRe2e1plots_ele_2017/',
		'ZJets_looseCRe2e0plots_ele_2017/',
		'ZJets_looseCRe3e1plots_ele_2017/',
		'ZJets_looseCRe2e2plots_ele_2017/',
		'ZJets_looseCRe3e0plots_ele_2017/'
		]
	elif finalState == "DiMu":
		folderName = [
		'ZJets_tightplots_mu_2017/',
		'ZJets_looseCRge2ge0plots_mu_2017/',
		'ZJets_looseCRge2e0plots_mu_2017/',
		'ZJets_looseCRe3ge2plots_mu_2017/',
		'ZJets_looseCRge4e0plots_mu_2017/',
		'ZJets_looseCRe2e1plots_mu_2017/',
		'ZJets_looseCRe2e0plots_mu_2017/',
		'ZJets_looseCRe3e1plots_mu_2017/',
		'ZJets_looseCRe2e2plots_mu_2017/',
		'ZJets_looseCRe3e0plots_mu_2017/'
		]
	else: print "Wrong channel name!!"
	...
	if finalState == "DiEle":
		folderName = [
		'ZJets_tightplots_ele_2018/',
		'ZJets_looseCRge2ge0plots_ele_2018/',
		'ZJets_looseCRge2e0plots_ele_2018/',
		'ZJets_looseCRe3ge2plots_ele_2018/',
		'ZJets_looseCRge4e0plots_ele_2018/',
		'ZJets_looseCRe2e1plots_ele_2018/',
		'ZJets_looseCRe2e0plots_ele_2018/',
		'ZJets_looseCRe3e1plots_ele_2018/',
		'ZJets_looseCRe2e2plots_ele_2018/',
		'ZJets_looseCRe3e0plots_ele_2018/'
		]
	elif finalState == "DiMu":
		folderName = [
		'ZJets_tightplots_mu_2018/',
		'ZJets_looseCRge2ge0plots_mu_2018/',
		'ZJets_looseCRge2e0plots_mu_2018/',
		'ZJets_looseCRe3ge2plots_mu_2018/',
		'ZJets_looseCRge4e0plots_mu_2018/',
		'ZJets_looseCRe2e1plots_mu_2018/',
		'ZJets_looseCRe2e0plots_mu_2018/',
		'ZJets_looseCRe3e1plots_mu_2018/',
		'ZJets_looseCRe2e2plots_mu_2018/',
		'ZJets_looseCRe3e0plots_mu_2018/'
		]
	else: print "Wrong channel name!!"
...
for i in folderName:
	myfile = ROOT.TFile(i+'myZJets_Prefit.root','read')
	
	MisIDEle   = myfile.Get("myZJets").Clone()   
	OtherHist  = myfile.Get("myBackground").Clone()
	MyDataHist = myfile.Get("data_obs").Clone() 
	...
	legend.AddEntry(MisIDEle,'ZJets','f')
	legend.AddEntry(OtherHist,'Background','f')
	legend.AddEntry(MySumHist,'Total','f')
	...
	MyDataHist.SetTitle(';;Events/1 GeV ')
	...
	ratio.GetXaxis().SetTitle('m_{%s%s} GeV'%(channel,channel))
	...
	canvasRatio.Print("%s%s_Prefit.pdf" %(i,'myZJets'))
	canvasRatio.Close()
	myfile.Close()
