...
if selYear == '2016':
	folderName = [
	'vGamma_tightplots_mu_2016/',
	'vGamma_looseCRge2ge0plots_mu_2016/',
	'vGamma_looseCRge2e0plots_mu_2016/',
	'vGamma_looseCRe3ge2plots_mu_2016/',
	'vGamma_looseCRge4e0plots_mu_2016/',
	'vGamma_looseCRe2e1plots_mu_2016/',
	'vGamma_looseCRe2e0plots_mu_2016/',
	'vGamma_looseCRe3e1plots_mu_2016/',
	'vGamma_looseCRe2e2plots_mu_2016/',
	'vGamma_looseCRe3e0plots_mu_2016/'
	]
	...
	folderName = [
	'vGamma_tightplots_mu_2017/',
	'vGamma_looseCRge2ge0plots_mu_2017/',
	'vGamma_looseCRge2e0plots_mu_2017/',
	'vGamma_looseCRe3ge2plots_mu_2017/',
	'vGamma_looseCRge4e0plots_mu_2017/',
	'vGamma_looseCRe2e1plots_mu_2017/',
	'vGamma_looseCRe2e0plots_mu_2017/',
	'vGamma_looseCRe3e1plots_mu_2017/',
	'vGamma_looseCRe2e2plots_mu_2017/',
	'vGamma_looseCRe3e0plots_mu_2017/'
	]
	...
	folderName = [
	'vGamma_tightplots_mu_2018/',
	'vGamma_looseCRge2ge0plots_mu_2018/',
	'vGamma_looseCRge2e0plots_mu_2018/',
	'vGamma_looseCRe3ge2plots_mu_2018/',
	'vGamma_looseCRge4e0plots_mu_2018/',
	'vGamma_looseCRe2e1plots_mu_2018/',
	'vGamma_looseCRe2e0plots_mu_2018/',
	'vGamma_looseCRe3e1plots_mu_2018/',
	'vGamma_looseCRe2e2plots_mu_2018/',
	'vGamma_looseCRe3e0plots_mu_2018/'
	]
...
for i in folderName:
	myfile = ROOT.TFile('MyFiles/'+i+'myVGamma_Prefit.root','read')
	
	MyZGamma   = myfile.Get("myZGamma").Clone()   
	MyWGamma   = myfile.Get("myWGamma").Clone()   
	OtherHist  = myfile.Get("myBackground").Clone()
	MyDataHist = myfile.Get("myData").Clone() 
	MySumHist  = myfile.Get("myTotal").Clone()

	MyZGamma.SetLineColor(ROOT.kRed)
	MyWGamma.SetLineColor(ROOT.kOrange)
	OtherHist.SetLineColor(ROOT.kBlue)
	MyDataHist.SetLineColor(ROOT.kBlack)
	MySumHist.SetLineColor(ROOT.kGreen+1)

	MyZGamma.  SetLineWidth(2)
	MyWGamma.  SetLineWidth(2)
	...
	legend.AddEntry(MyWGamma,'WGamma','f')
	legend.AddEntry(MyZGamma,'ZGamma','f')
	...
	MyWGamma. Draw("hist,same")
	MyZGamma. Draw("hist,same")
	...
	canvasRatio.Print("MyFiles/%s%s_Prefit.pdf" %(i,'myVGamma'))
	canvasRatio.Close()
	myfile.Close()
